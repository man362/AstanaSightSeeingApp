...
public class Utility {
    ...
    static void populateTheHashMap(int i, HashMap<String,Integer> pPhotos){
        switch (i){
            ...
            case 0:
                pPhotos.put("Photo 2", R.drawable.hazret_sultan_from_sides);
                pPhotos.put("Photo 3", R.drawable.hazret_sultan_from_sides_left);
                pPhotos.put("Photo 4", R.drawable.hazret_sultan_front_side_night);
                pPhotos.put("Photo 5", R.drawable.hazret_sultan_inside);
                pPhotos.put("Photo 6", R.drawable.hazret_sultan_inside_zal1);
                pPhotos.put("Photo 7", R.drawable.hazret_sultan_night);
                pPhotos.put("Photo 8", R.drawable.hazret_sultan_night_salut);
                pPhotos.put("Photo 9", R.drawable.hazret_sultan_pic);
                break;
            case 1:
